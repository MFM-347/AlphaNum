# Contributing to AlphaNum

Thank you for considering contributing to AlphaNum! 🎉  
...
1. Navigate to the [AlphaNum repository](https://github.com/MFM-347/AlphaNum).
...
```bash
git clone https://github.com/<your-username>/AlphaNum.git
cd AlphaNum
```
...
Then, navigate to the **original AlphaNum repository** and submit a pull request.  
...
Encountered a bug or have a great idea for a new feature? Create an issue [here](https://github.com/MFM-347/AlphaNum/issues).
...
- Start a [discussion](https://github.com/MFM-347/AlphaNum/discussions).
- Join our community for support and collaboration.

Thank you ✨ for contributing to AlphaNum! Your effort makes this project better for everyone.
